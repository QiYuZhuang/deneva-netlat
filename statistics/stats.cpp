...
void Stats_thd::print_client(FILE *outf, bool prog) {
    ...
    fprintf(outf,
            ...
            msg_queue_delay_time_avg / BILLION, msg_send_time / BILLION,
            msg_send_time_avg / BILLION, msg_recv_time / BILLION, msg_recv_time_avg / BILLION,
            msg_recv_idle_time / BILLION, msg_batch_cnt, msg_batch_size_msgs,
            msg_batch_size_msgs_avg, msg_batch_size_bytes, msg_batch_size_bytes_avg,
            msg_batch_size_bytes_to_server, msg_batch_size_bytes_to_client, msg_send_cnt,
            msg_recv_cnt, msg_unpack_time / BILLION, msg_unpack_time_avg / BILLION,
...
void Stats_thd::print(FILE *outf, bool prog) {
    ...
    fprintf(outf,
            ...
            local_txn_commit_cnt, remote_txn_commit_cnt, total_txn_abort_cnt,
            positive_txn_abort_cnt, unique_txn_abort_cnt, local_txn_abort_cnt, remote_txn_abort_cnt,
            txn_run_time / BILLION, txn_run_avg_time / BILLION, multi_part_txn_cnt,
            multi_part_txn_run_time / BILLION, multi_part_txn_avg_time / BILLION,
            single_part_txn_cnt, single_part_txn_run_time / BILLION,
            single_part_txn_avg_time / BILLION, txn_write_cnt, record_write_cnt, parts_touched,
            avg_parts_touched);
    ...
    fprintf(outf,
            ...
            trans_get_access_time / BILLION, trans_store_access_time / BILLION,
            trans_get_row_time / BILLION, trans_benchmark_compute_time / BILLION,
            trans_2pc_time / BILLION, trans_prepare_time / BILLION, trans_validate_time / BILLION,
            trans_finish_time / BILLION, trans_commit_time / BILLION, trans_abort_time / BILLION,
            trans_access_lock_wait_time / BILLION,
            // trans network
            trans_process_network / BILLION, trans_validation_network / BILLION,
            trans_commit_network / BILLION, trans_abort_network / BILLION,
            ...
            dli_init_time / BILLION, dli_lock_time / BILLION, dli_check_conflict_time / BILLION,
            dli_final_validate / BILLION, dli_get_rwset / BILLION, dli_push_front_time / BILLION,
            ...
            trans_network_wait / BILLION, trans_network_send / BILLION,
            trans_network_recv / BILLION, trans_msgsend_stage_one / BILLION,
            trans_msgsend_stage_three / BILLION, trans_get_client_wait / BILLION,
            trans_return_client_wait / BILLION, trans_process_client / BILLION);
    ...
    fprintf(outf,
            ...
            trans_init_time / (trans_init_count * BILLION),
            trans_process_time / (trans_process_count * BILLION),
            trans_get_access_time / (trans_get_access_count * BILLION),
            trans_store_access_time / (trans_store_access_count * BILLION),
            trans_get_row_time / (trans_get_row_count * BILLION),
            trans_2pc_time / (trans_2pc_count * BILLION),
            trans_prepare_time / (trans_prepare_count * BILLION),
            trans_validate_time / (trans_validate_count * BILLION),
            trans_finish_time / (trans_finish_count * BILLION),
            trans_commit_time / (trans_commit_count * BILLION),
            trans_abort_time / (trans_abort_count * BILLION),
            // trans network
            trans_process_network / (trans_process_count * BILLION),
            trans_validation_network / (trans_validate_count * BILLION),
            trans_commit_network / (trans_commit_count * BILLION),
            trans_abort_network / (trans_abort_count * BILLION));
    fprintf(outf,
            ...
            trans_total_count, trans_init_count, trans_process_count, trans_get_access_count,
            trans_store_access_count, trans_get_row_count, trans_2pc_count, trans_prepare_count,
            trans_validate_count, trans_finish_count, trans_commit_count, trans_abort_count,
            trans_work_queue_item_total, trans_msg_queue_item_total,
    ...
    fprintf(outf,
            ...
            work_queue_mtx_wait_avg / BILLION, work_queue_new_cnt,
            work_queue_new_wait_time / BILLION, work_queue_new_wait_avg_time / BILLION,
            work_queue_old_cnt, work_queue_old_wait_time / BILLION,
            work_queue_old_wait_avg_time / BILLION, work_queue_enqueue_time / BILLION,
            work_queue_dequeue_time / BILLION, work_queue_conflict_cnt);
    ...
    for (uint64_t i = 0; i < SECOND; i++) {
        fprintf(outf,
                ...
                i, work_queue_wq_cnt[i], i, work_queue_tx_cnt[i]);
    }
    ...
    for (uint64_t i = 0; i < SECOND; i++) {
        fprintf(outf,
                ...
                i, work_queue_ewq_cnt[i], i, work_queue_dwq_cnt[i]);
    }
    ...
    for (uint64_t i = 0; i < SECOND; i++) {
        fprintf(outf,
                ...
                i, work_queue_etx_cnt[i], i, work_queue_dtx_cnt[i]);
    }
    ...
    fprintf(outf,
            ...
            lat_work_queue_time / BILLION, lat_msg_queue_time / BILLION,
            lat_cc_block_time / BILLION, lat_cc_time / BILLION, lat_process_time / BILLION,
            lat_abort_time / BILLION, lat_network_time / BILLION, lat_other_time / BILLION,
            lat_l_loc_work_queue_time / BILLION, lat_l_loc_msg_queue_time / BILLION,
            lat_l_loc_cc_block_time / BILLION, lat_l_loc_cc_time / BILLION,
            lat_l_loc_process_time / BILLION, lat_l_loc_abort_time / BILLION,
            lat_short_work_queue_time / BILLION, lat_short_msg_queue_time / BILLION,
            lat_short_cc_block_time / BILLION, lat_short_cc_time / BILLION,
            lat_short_process_time / BILLION, lat_short_network_time / BILLION,
            lat_short_batch_time / BILLION, lat_s_loc_work_queue_time / BILLION,
            lat_s_loc_msg_queue_time / BILLION, lat_s_loc_cc_block_time / BILLION,
            lat_s_loc_cc_time / BILLION, lat_s_loc_process_time / BILLION,
            lat_l_rem_work_queue_time / BILLION, lat_l_rem_msg_queue_time / BILLION,
            lat_l_rem_cc_block_time / BILLION, lat_l_rem_cc_time / BILLION,
            lat_l_rem_process_time / BILLION, lat_s_rem_work_queue_time / BILLION,
            lat_s_rem_msg_queue_time / BILLION, lat_s_rem_cc_block_time / BILLION,
            lat_s_rem_cc_time / BILLION, lat_s_rem_process_time / BILLION);
    fprintf(outf,
    ...
    if (!prog) {
        ...
        fprintf(outf,
                ...
                (double)first_start_commit_latency.get_idx(first_start_commit_latency.cnt - 1) /
                    BILLION,
        ...
        fprintf(outf,
                ...
                (double)start_abort_commit_latency.get_idx(start_abort_commit_latency.cnt - 1) /
                    BILLION,
