...
private:
    ...
    // SA
public:
    void init_SA_Params(double t_initial, double t_denominator, double k, double t_min,
...
public:
    ...
    bool operator==(const TxnNode &b) const { return (txn_id == b.txn_id) && (thd_id == b.thd_id); }
};
